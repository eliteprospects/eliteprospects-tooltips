...
Handlebars.templates=Handlebars.templates||{},Handlebars.templates.player=Handlebars.template(function(t,a,r,n,l){function e(t){var a,r="";return r+="\r\n                            "+p((a=t&&t.latestPlayerStats,a=null==a||a===!1?a:a.team,a=null==a||a===!1?a:a.name,typeof a===o?a.apply(t):a))+"\r\n                        "}function d(t,a){var n,l,e="";return e+="\r\n                            ",(l=r.playerStatus)?n=l.call(t,{hash:{},data:a}):(l=t&&t.playerStatus,n=typeof l===o?l.call(t,{hash:{},data:a}):l),e+=p(n)+"\r\n                        "}this.compilerInfo=[4,">= 1.0.0"],r=this.merge(r,t.helpers),l=l||{};var s,h,i="",o="function",p=this.escapeExpression,c=this;return i+='<div class="epPlayer">\r\n    <div class="profilePhoto">\r\n        <img src="http://files.eliteprospects.com/layout/players/',(h=r.imageUrl)?s=h.call(a,{hash:{},data:l}):(h=a&&a.imageUrl,s=typeof h===o?h.call(a,{hash:{},data:l}):h),i+=p(s)+'"/>\r\n    </div>\r\n    <h3>\r\n        <img src="http://beta.eliteprospects.com/images/flags/32/'+p((s=a&&a.country,s=null==s||s===!1?s:s.abbreviation,typeof s===o?s.apply(a):s))+'.png"/>\r\n        ',(h=r.firstName)?s=h.call(a,{hash:{},data:l}):(h=a&&a.firstName,s=typeof h===o?h.call(a,{hash:{},data:l}):h),i+=p(s)+" ",(h=r.lastName)?s=h.call(a,{hash:{},data:l}):(h=a&&a.lastName,s=typeof h===o?h.call(a,{hash:{},data:l}):h),i+=p(s)+'\r\n    </h3>\r\n    <div class="playerData">\r\n        <table>\r\n            <tbody>\r\n                <tr>\r\n                    <td>Team:</td>\r\n                    <td>\r\n                        ',s=r["if"].call(a,a&&a.isActive,{hash:{},inverse:c.program(3,d,l),fn:c.program(1,e,l),data:l}),(s||0===s)&&(i+=s),i+="\r\n                    </td>\r\n                </tr>\r\n                <tr>\r\n                    <td>Nation:</td>\r\n                    <td>"+p((s=a&&a.country,s=null==s||s===!1?s:s.name,typeof s===o?s.apply(a):s))+"</td>\r\n                </tr>\r\n                <tr>\r\n                    <td>Position:</td>\r\n                    <td>",(h=r.playerPosition)?s=h.call(a,{hash:{},data:l}):(h=a&&a.playerPosition,s=typeof h===o?h.call(a,{hash:{},data:l}):h),i+=p(s)+"</td>\r\n                </tr>\r\n                <tr>\r\n                    <td>Shoots:</td>\r\n                    <td>",(h=r.shoots)?s=h.call(a,{hash:{},data:l}):(h=a&&a.shoots,s=typeof h===o?h.call(a,{hash:{},data:l}):h),i+=p(s)+'</td>\r\n                </tr>\r\n            </tbody>\r\n        </table>\r\n    </div>\r\n\r\n    <div class="playerData">\r\n        <table>\r\n            <tbody>\r\n                <tr>\r\n                    <td>Birthplace:</td>\r\n                    <td>\r\n                        '+p((s=a&&a.birthPlace,s=null==s||s===!1?s:s.name,typeof s===o?s.apply(a):s))+", "+p((s=a&&a.birthPlace,s=null==s||s===!1?s:s.country,s=null==s||s===!1?s:s.abbreviation,typeof s===o?s.apply(a):s))+"\r\n                    </td>\r\n                </tr>\r\n                <tr>\r\n                    <td>Birthday:</td>\r\n                    <td>",(h=r.dateOfBirth)?s=h.call(a,{hash:{},data:l}):(h=a&&a.dateOfBirth,s=typeof h===o?h.call(a,{hash:{},data:l}):h),i+=p(s)+"</td>\r\n                </tr>\r\n                <tr>\r\n                    <td>Youth team:</td>\r\n                    <td>"+p((s=a&&a.clubOfOrigin,s=null==s||s===!1?s:s.name,typeof s===o?s.apply(a):s))+"</td>\r\n                </tr>\r\n                <tr>\r\n                    <td>Height:</td>\r\n                    <td>",(h=r.height)?s=h.call(a,{hash:{},data:l}):(h=a&&a.height,s=typeof h===o?h.call(a,{hash:{},data:l}):h),i+=p(s)+"</td>\r\n                </tr>\r\n                <tr>\r\n                    <td>Weight:</td>\r\n                    <td>",(h=r.weight)?s=h.call(a,{hash:{},data:l}):(h=a&&a.weight,s=typeof h===o?h.call(a,{hash:{},data:l}):h),i+=p(s)+"</td>\r\n                </tr>\r\n            </tbody>\r\n        </table>\r\n    </div>\r\n</div>\r\n"});
...
!function(n,e){var a=n.createElement("style");if(n.getElementsByTagName("head")[0].appendChild(a),a.styleSheet)a.styleSheet.disabled||(a.styleSheet.cssText=e);else try{a.innerHTML=e}catch(t){a.innerText=e}}(document,'\n/* OPENTIP OVERRIDES */\n.opentip-container .opentip {\n	padding: 0;\n	overflow: hidden;\n	border-radius: 3px;\n	font-family: sans-serif;\n}\n\n/* EP TOOLTIP STYLING */\n.epPlayer {\n	border-top: 10px solid #0a2f40;\n	padding: 20px;\n}\n\n.epPlayer:after {\n	content: "";\n	display: table;\n	clear: both;\n}\n\n.epPlayer .profilePhoto {\n	width: 150px;\n	margin: 0 auto;\n}\n\n.epPlayer .profilePhoto img {\n	max-width: 100%;\n}\n\n.epPlayer h3 {\n	margin: 5px;\n}\n\n.epPlayer h3 img {\n	vertical-align: middle;\n}\n\n.epPlayer .playerData {\n	font-size: 11px;\n	width: 50%;\n	float: left;\n}\n\n.epPlayer .playerData table {\n	table-layout: fixed;\n}\n\n.epPlayer .playerData td {\n	text-align: left;\n}\n\n.epPlayer .playerData td:first-child {\n	text-align: right;\n	color: #cccccc;\n}');
var playerLinkPattern=/http:\/\/www\.eliteprospects\.com\/player\.php\?player=(\d+)/,playerApiEndpoint="http://api.eliteprospects.com/beta/players/[playerId]";Opentip.prototype.setContent=function(e){if(e){var t=Handlebars.getTemplate("player"),a=JSON.parse(e).data;a.isActive="ACTIVE"==a.playerStatus,this.content=t(a)}return this._newContent=!0,this.visible?this._updateElementContent():void 0},Opentip.styles.ep={"extends":"glass",className:"ep",tipJoint:"left",background:"#ffffff",borderRadius:3,borderWidth:0,shadowOffset:[0,4],shadowColor:"rgba(0,0,0,0.15)",shadowBlur:25};for(var links=document.getElementsByTagName("a"),match,i=0;i<links.length;i++){var a=links[i];(match=playerLinkPattern.exec(a.href))&&new Opentip(a,{style:"ep",ajax:playerApiEndpoint.replace("[playerId]",match[1])})}
